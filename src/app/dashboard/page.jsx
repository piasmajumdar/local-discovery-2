        ...
        <div className="min-h-screen bg-gray-50 pb-20">
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
                    {/* Cover Header */}
                    <div className="h-32 bg-gradient-to-r from-[#ff8938] to-[#ff0000]"></div>
                    ...
                    <div className="px-8 pb-10">
                        ...
                        <div className="relative flex flex-col md:flex-row items-center md:items-end -mt-16 mb-8 gap-6">
                            ...
                            <div className="flex gap-3">
                                ...
                                <button className="px-6 py-2.5 bg-[#ff8938] hover:bg-[#ff0000] text-white font-bold rounded-xl shadow-md hover:shadow-lg transition-all">
                                    Manage Shops
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="p-6 bg-orange-50 rounded-2xl border border-orange-100">
                                <p className="text-orange-600 text-sm font-bold uppercase tracking-wider mb-1">My Shops</p>
                                <h3 className="text-3xl font-bold text-gray-900">{user?.addedShops?.length || 0}</h3>
                            </div>
                            <div className="p-6 bg-red-50 rounded-2xl border border-red-100">
                                <p className="text-red-600 text-sm font-bold uppercase tracking-wider mb-1">My Reviews</p>
                                <h3 className="text-3xl font-bold text-gray-900">{user?.myReviews?.length || 0}</h3>
                            </div>
                            <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                                <p className="text-gray-600 text-sm font-bold uppercase tracking-wider mb-1">Member Since</p>
                        ...
                        <div className="mt-12 text-center p-12 border-2 border-dashed border-gray-200 rounded-3xl">
                            ...
                            <h3 className="text-xl font-bold text-gray-800">Your Activity Timeline</h3>
                            <p className="text-gray-500 max-w-sm mx-auto mt-2">We'll show your recent activity and saved places here soon!</p>
                        </div>
                    </div>
                </div>
            </main>
